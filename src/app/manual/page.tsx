...
import { Home, Calendar, Users, FolderKanban, ArrowRight, Menu, X, PlaneTakeoff, Info, Building2, Settings } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'tramites', label: 'Seguimiento de Trámites', icon: FolderKanban },
  { id: 'perfil', label: 'Perfil de Compañía', icon: Building2 },
        ...
        <main>
          ...
          >
            <AnimatedCard>
                ...
                <CardContent className="space-y-3 text-muted-foreground">
                    ...
                    <p>• Personaliza qué tarjetas de información deseas ver desde el menú de Configuración.</p>
                </CardContent>
            </AnimatedCard>
          </FeatureSection>
          ...
          >
           ...
           <FeatureSection
            ...
            description="Administra todas las habilitaciones de seguridad de tu equipo. Registra nuevo personal, edita perfiles existentes y consulta información detallada, incluyendo recomendaciones médicas y estadísticas de habilitaciones."
            imgSrc="https://placehold.co/1200x800.png"
          ...
          >
            <AnimatedCard>
                ...
                <CardContent className="space-y-3 text-muted-foreground">
                    <p>• Registra y edita perfiles con un formulario completo y guiado.</p>
                    <p>• Visualiza estadísticas de habilitaciones y recomendaciones médicas.</p>
                    <p>• Utiliza filtros potentes para encontrar rápidamente a quien buscas.</p>
                    <p>• Consulta un perfil detallado de cada miembro con su CV imprimible.</p>
                </CardContent>
            </AnimatedCard>
          </FeatureSection>
          ...
          <FeatureSection
            ...
            description="Consulta el estado y el progreso de todas tus solicitudes. Desde la recepción hasta la entrega, visualiza cada paso en una línea de tiempo interactiva. Accede a los hallazgos, discrepancias, y documentos adjuntos de cada trámite."
            imgSrc="https://placehold.co/1200x800.png"
          ...
          >
            <AnimatedCard>
                ...
                <CardContent className="space-y-3 text-muted-foreground">
                    <p>• Inicia nuevas solicitudes con un asistente guiado paso a paso.</p>
                    <p>• Monitorea el progreso de cada trámite con una línea de tiempo visual.</p>
                    <p>• Revisa discrepancias y hallazgos detallados para tomar acción.</p>
                    <p>• Consulta los resultados de las evaluaciones de tu personal.</p>
                </CardContent>
            </AnimatedCard>
          </FeatureSection>
          ...
          <FeatureSection
            ...
            description="Mantén actualizada la información de tu empresa. Es crucial que los datos como el RNC, representante legal y dirección fiscal sean correctos para garantizar la validez de los trámites y una comunicación fluida."
            imgSrc="https://placehold.co/1200x800.png"
            imgHint="company profile"
          >
            <AnimatedCard>
                <CardHeader>
                    <CardTitle className="text-lg flex items-center gap-2"><Info className="h-5 w-5 text-primary"/>Puntos Clave</CardTitle>
                ...
                <CardContent className="space-y-3 text-muted-foreground">
                    <p>• La información de perfil es utilizada en todos los documentos oficiales.</p>
                    <p>• Edita fácilmente los datos de contacto y fiscales.</p>
                    <p>• Un perfil completo y actualizado previene retrasos en las solicitudes.</p>
                </CardContent>
            </AnimatedCard>
          </FeatureSection>
          ...
          <FeatureSection
            ...
            description="Personaliza tu experiencia en el portal. Desde el menú de configuración accesible desde tu perfil, puedes ajustar la apariencia del portal (modo claro/oscuro) y personalizar las tarjetas de información que se muestran en tu dashboard."
            imgSrc="https://placehold.co/1200x800.png"
            imgHint="settings interface"
            reverse
          >
            <AnimatedCard>
                <CardHeader>
                ...
                <CardContent className="space-y-3 text-muted-foreground">
                    <p>• Cambia entre tema claro y oscuro para tu comodidad visual.</p>
                    <p>• Elige qué tarjetas de resumen (KPIs) son más importantes para ti.</p>
                    <p>• Los cambios se guardan y se aplican instantáneamente en tu cuenta.</p>
                </CardContent>
            </AnimatedCard>
          </FeatureSection>
        </main>
